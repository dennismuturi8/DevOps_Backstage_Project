...
const workflowAccess = (z) => z.enum(["none", "organization", "user"], {
  description: 'Level of access for workflows outside of the repository. Default is "none".'
}).optional();
...
exports.workflowAccess = workflowAccess;
