...
:host {
  ...
  --md-default-fg-color--lighter: ${(0,tt.X4)(e.palette.text.secondary,.3)};
  --md-default-fg-color--lightest: ${(0,tt.X4)(e.palette.text.secondary,.15)};
...
:host > * {
  ...
  --md-typeset-table-color: ${(0,tt.X4)(e.palette.text.primary,.15)};
