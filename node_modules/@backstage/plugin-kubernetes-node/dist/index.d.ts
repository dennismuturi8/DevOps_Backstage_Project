...
import { KubernetesObjectsProvider as KubernetesObjectsProvider$1, KubernetesClustersSupplier as KubernetesClustersSupplier$1, KubernetesServiceLocator as KubernetesServiceLocator$1, KubernetesFetcher as KubernetesFetcher$1, CustomResource as CustomResource$1, ObjectToFetch as ObjectToFetch$1, AuthenticationStrategy as AuthenticationStrategy$1 } from '@backstage/plugin-kubernetes-node';
 ...
 * @public
 */
type KubernetesRouterFactory = (opts: {
 ...
 * @public
 */
interface KubernetesRouterExtensionPoint {
 ...
 * @public
 */
declare const kubernetesRouterExtensionPoint: _backstage_backend_plugin_api.ExtensionPoint<KubernetesRouterExtensionPoint>;
...
declare class PinnipedHelper {
    ...
    tokenCredentialRequest(clusterDetails: ClusterDetails, pinnipedParams: PinnipedParameters): Promise<PinnipedClientCerts>;
    private exchangeClusterTokentoClientCerts;
    private buildRequestForPinniped;
}

export { PinnipedHelper, kubernetesAuthStrategyExtensionPoint, kubernetesClusterSupplierExtensionPoint, kubernetesFetcherExtensionPoint, kubernetesObjectsProviderExtensionPoint, kubernetesRouterExtensionPoint, kubernetesServiceLocatorExtensionPoint };
export type { AuthMetadata, AuthenticationStrategy, ClusterDetails, CustomResource, CustomResourcesByEntity, FetchResponseWrapper, KubernetesAuthStrategyExtensionPoint, KubernetesClusterSupplierExtensionPoint, KubernetesClusterSupplierFactory, KubernetesClustersSupplier, KubernetesCredential, KubernetesFetcher, KubernetesFetcherExtensionPoint, KubernetesFetcherFactory, KubernetesObjectTypes, KubernetesObjectsByEntity, KubernetesObjectsProvider, KubernetesObjectsProviderExtensionPoint, KubernetesObjectsProviderFactory, KubernetesRouterExtensionPoint, KubernetesRouterFactory, KubernetesServiceLocator, KubernetesServiceLocatorExtensionPoint, KubernetesServiceLocatorFactory, ObjectFetchParams, ObjectToFetch, PinnipedClientCerts, PinnipedParameters, ServiceLocatorRequestContext };
