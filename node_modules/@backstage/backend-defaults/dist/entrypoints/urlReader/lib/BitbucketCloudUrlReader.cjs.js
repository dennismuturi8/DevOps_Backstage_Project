...
class BitbucketCloudUrlReader {
  ...
  constructor(integration, deps) {
    ...
    this.deps = deps;
    const { host, username, appPassword, token, clientId, clientSecret } = integration.config;
  ...
  async readUrl(url, options) {
    ...
    const requestOptions = await integration.getBitbucketCloudRequestOptions(
      this.integration.config
    );
    let response;
    try {
  ...
  async readTree(url, options) {
    ...
    const archiveResponse = await fetch(
      downloadUrl,
      await integration.getBitbucketCloudRequestOptions(this.integration.config)
    );
...
//# sourceMappingURL=BitbucketCloudUrlReader.cjs.js.map
